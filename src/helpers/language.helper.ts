...
export function dateInterval(date: number): string {
	...
	if(interval < 60) {
		...
		value = "минут";
		if(Math.floor(interval / 60) % 10 == 1 && Math.floor(interval / 60) % 100 != 1){
		...
		value = "час";
		if(Math.floor(interval / 3600) % 10 == 1 && Math.floor(interval / 3600) % 100 != 1){
			return `${Math.floor(interval / 3600)} ${value}`;
		} else if(Math.floor(interval / 3600) % 10 < 5 && Math.floor(interval / 3600) % 100 != 1){
		...
		value = "д";
		if(Math.floor(interval / 86400) % 10 == 1 && Math.floor(interval / 86400) % 100 != 1){
			return `${Math.floor(interval / 86400)} ${value}ень`;
		} else if(Math.floor(interval / 86400) % 10 < 5 && Math.floor(interval / 86400) % 100 != 1){
		...
		value = "недел";
		if(Math.floor(interval / 604800) % 10 == 1 && Math.floor(interval / 604800) % 100 != 1){
			return `${Math.floor(interval / 604800)} ${value}ень`;
		} else if(Math.floor(interval / 604800) % 10 < 5 && Math.floor(interval / 604800) % 100 != 1){
		...
		value = "месяц";
		if(Math.floor(interval / 2678400) % 10 == 1 && Math.floor(interval / 2678400) % 100 != 1){
			return `${Math.floor(interval / 2678400)} ${value}`;
		} else if(Math.floor(interval / 2678400) % 10 < 5 && Math.floor(interval / 2678400) % 100 != 1){
		...
		if(Math.floor(interval / 31536000) % 10 == 1 && Math.floor(interval / 31536000) % 100 != 1){
